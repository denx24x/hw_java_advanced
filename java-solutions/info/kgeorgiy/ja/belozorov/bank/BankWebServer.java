...
//            "  <td>{level}</td>" +
    ...
    private final Map<String, App> apps = Map.ofEntries(
            app("Client 1", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.belozorov.bank.Client", "client-1"),
            app("Client 2", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.belozorov.bank.Client", "client-2"),
            app("Client 3", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.belozorov.bank.Client", "client-3"),
            app("Server 1", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.belozorov.bank.Server", "8881"),
            app("Server 2", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.belozorov.bank.Server", "8882"),
